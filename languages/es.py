...
'En el post': 'En el post',
'En el post %s': 'En el post %s',
'enter an integer between %(min)g and %(max)g': 'enter an integer between %(min)g and %(max)g',
'Error logs for "%(app)s"': 'Bitácora de errores en "%(app)s"',
'errors': 'errores',
'Errors': 'Errors',
'Este post no te pertenece': 'Este post no te pertenece',
'Este post no tiene comentarios, soyez le premier': 'Este post no tiene comentarios, soyez le premier',
...
'Groups': 'Groups',
'Haz un comentario': 'Haz un comentario',
...
'Puntos': 'Puntos',
'Puntuar': 'Puntuar',
'Puntuaste el post con %s puntos': 'Puntuaste el post con %s puntos',
'Python': 'Python',
'Query:': 'Consulta:',
